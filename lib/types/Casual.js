...
var Casual = exports.Casual = function (_Plugin) {
  _inherits(Casual, _Plugin);

  function Casual(generator) {
    _classCallCheck(this, Casual);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Casual).call(this));
